        ...
        <div className='container'>
          <div className='row'>
              ...
              <ul className='break-lunch-dinner d-flex'>
                <li>
                  <button
                    className={
                      activeBreakfast
                        ? 'active btn btn-outline-danger btn-sm'
            ...
            <div className='f-right d-flex align-items-center text-danger'>
              <p
                className='all-product ml-auto p-2'
          ...
          <div className='row single-category-food'>
            {foodItems.map(itemPd => (
              <SingleFood key={itemPd.id} itemPd={itemPd}></SingleFood>
            ))}

            <div className='checkout-btn m-auto'>
              <button className='btn btn-secondary btn-lg d-flex' disabled>
                Checkout your food
              </button>
            </div>
          </div>
